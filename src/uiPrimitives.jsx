...
function IsoLabel({ x, y, text, color = "#e2e8f0", size = 9, anchor = "middle" }) {
  return (
    <text x={x} y={y} textAnchor={anchor} fontSize={size} fill={color}
      ...
      stroke="#0f172a" strokeWidth="3" strokeLinejoin="round">
      {text}
    </text>
  );
}
...
function DiagLRLoadCases({ codeVer }) {
  ...
  return (
    <>
      ...
      >
        ...
        {scale > 1 && (
          <div style={{
            ...
            background: "rgba(15,23,42,0.75)", color: "#7dd3fc",
        ...
        {scale === 1 && (
          <div style={{
            position: "absolute", bottom: 6, right: 6,
            background: "rgba(15,23,42,0.65)", color: "#475569",
      ...
      {/* Note */}
      <div style={{ padding: "10px 12px", background: "#0c1a2e", borderTop: "1px solid #1e293b" }}>
        {note.split("\n\n").map((para, i) => (
          <p key={i} style={{
            fontSize: 10, lineHeight: 1.6, color: i === 0 ? "#94a3b8" : "#64748b",
    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          color: "#475569", fontFamily: "'IBM Plex Sans', sans-serif",
        ...
        <div style={{ padding: "12px 10px" }}>
          <div style={{ borderRadius: 6, overflow: "hidden", border: "1px solid #1e293b" }}>
            <div style={{ padding: "5px 10px", background: "#0f172a", borderBottom: "1px solid #1e293b",
  ...
  return (
    <div style={{
      ...
      <div style={{ padding: "12px 10px", display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        <div style={{ borderRadius: 6, overflow: "hidden", border: "1px solid #1e293b" }}>
          <div style={{ padding: "5px 10px", background: "#0f172a", borderBottom: "1px solid #1e293b",
            fontSize: 12, fontWeight: 700, color: dirSub === "normal" ? "#7dd3fc" : "#475569",
            letterSpacing: "0.08em", fontFamily: "monospace", textTransform: "uppercase" }}>
        ...
        <div style={{ borderRadius: 6, overflow: "hidden", border: "1px solid #1e293b" }}>
          <div style={{ padding: "5px 10px", background: "#0f172a", borderBottom: "1px solid #1e293b",
            fontSize: 12, fontWeight: 700, color: dirSub === "parallel" ? "#7dd3fc" : "#475569",
            letterSpacing: "0.08em", fontFamily: "monospace", textTransform: "uppercase" }}>
